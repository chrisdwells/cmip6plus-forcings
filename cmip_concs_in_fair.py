...
for spec in plot_list:
    ...
    plt.plot(f_cmip7.timebounds, f_cmip7.concentration[:,0,0,f_ssps.species.index(spec)], label='CMIP7', color=colors['CMIP7'])
    ...
    if spec in ['CO2', 'CH4', 'N2O']:
        ...
        plt.plot(f_cmip7_inc_wmghgs.timebounds, f_cmip7_inc_wmghgs.concentration[
    ...
    plt.savefig(
        f"plots/plots_fair/{spec}_concentration.png", dpi=100
    )
    ...
    plt.plot(f_cmip7.timebounds, f_cmip7.forcing[:,0,0,f_ssps.species.index(spec)], label='CMIP7', color=colors['CMIP7'])
    ...
    if spec in ['CO2', 'CH4', 'N2O']:
        ...
        plt.plot(f_cmip6plus_inc_wmghgs.timebounds, f_cmip6plus_inc_wmghgs.forcing[
            :,0,0,f_ssps.species.index(spec)], label='CMIP6Plus inc. WMGHGs', color=colors['CMIP6Plus'], linestyle='--')
        plt.plot(f_cmip6plus_inc_wmghgs.timebounds, f_cmip7_inc_wmghgs.forcing[
            :,0,0,f_ssps.species.index(spec)], label='CMIP7 inc. WMGHGs', color=colors['CMIP7'], linestyle='--')
    ...
    plt.savefig(
        f"plots/plots_fair/{spec}_forcing.png", dpi=100
    )
#%%
...
plt.savefig(
    "plots/plots_fair/GMST.png", dpi=100
)
...
plt.savefig(
    "plots/plots_fair/Forcing.png", dpi=100
)
...
with open('save_forcings.pkl', 'wb') as handle:
